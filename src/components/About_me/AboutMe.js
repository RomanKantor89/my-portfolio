      ...
      <div className="page">
        ...
        <div className="main">
          <div className="about-text">
            <p>
              Hello, I'm Roman, an enthusiastic software developer with 3 years of experience in automation and a profound fascination with web technologies and tools. 
            </p><br/>
            <p>
